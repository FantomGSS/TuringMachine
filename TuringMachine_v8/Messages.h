...
const std::string PROCESSED_SUCCESSFULLY = "The tape was processed successfully! Head position: ";
const std::string NOT_PROCESSED_SUCCESSFULLY = "The tape was not processed successfully! Head position: ";
