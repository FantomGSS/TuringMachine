...
bool TuringMachine::checkTransitionFormat(const std::string& line)
{
...
void TuringMachine::optionSelectingInspection(const std::vector<int>& headPositions)
{
	std::string option;
	while (1)
	{
...
void TuringMachine::branch(TuringMachine& positiveTuringMachine, TuringMachine& negativeTuringMachine)
{
